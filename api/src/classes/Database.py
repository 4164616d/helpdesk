# flake8-in-file-ignores: noqa: E501,E722
...
class Database:
    ...
    def __init__(self):
        if (os.getenv('MODE') == "test"):
            ...
            if (self.connection_attemps < 6):
                ...
                print("Connecting to SQL Server. Attempt:",
                      self.connection_attemps)
                try:
                    ...
                    print("Connection error, waiting:",
                          (self.connection_attemps + 1)**2, " seconds")
    ...
    def insert_into_tickets(self, title, description, status, user_id):
        ...
        self.cursor.execute(insert_ticket_query,
